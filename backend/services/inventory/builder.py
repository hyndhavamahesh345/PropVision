...
HOUSEHOLD_OBJECTS = [
    ...
    "blanket", "air conditioner", "heater", "water heater", "geyser", "bathroom water heater", "wall-mounted water heater", "water boiler", "fireplace", "staircase",
...
UNIQUE_HOUSEHOLD_OBJECTS = sorted(list(set([
    ...
    "heater", "water heater", "geyser", "bathroom water heater", "wall-mounted water heater", "water boiler", "fireplace", "staircase", "drawer", "nightstand", 
...
CANONICAL = {
    ...
    "pillow": "pillow",
    "air conditioner": "air conditioner", "heater": "heater", "water heater": "geyser", "geyser": "geyser", "ac": "air conditioner", "bathroom water heater": "geyser", "wall-mounted water heater": "geyser", "water boiler": "geyser", "small water tank": "geyser",
